...
class DetailAsesorModel extends Model
{
    ...
    protected $allowedFields = ['email', 'nama_lengkap', 'nip_nidn', 'tempat_lahir', 'tanggal_lahir', 'pangkat_golongan', 'jabatan', 'bidang_ilmu_keahlian', 'pendidikan_terakhir', 'telepon', 'alamat','file_bukti', 'created_at'];
