                ...
                <div class="pb-5 fs-6">
                    ...
                    <?php if ($dtpendaftaran): ?>
                        <?php foreach ($dtpendaftaran as $row): ?>
                            ...
                            <div class="text-gray-600"><?= $row['nama_lengkap'] ?></div>

                            <div class="fw-bold mt-5">Email</div>
                            <div class="text-gray-600"><?= $row['email'] ?></div>
                            
                            <div class="fw-bold mt-5">N I K</div>
                            <div class="text-gray-600"><?= $row['nik'] ?></div>
                            
                            <div class="fw-bold mt-5">Tempat dan Tanggal lahir</div>
                            <div class="text-gray-600"><?= $row['tempat_lahir'] ?>, <?= $row['tanggal_lahir'] ?></div>
                            
                            <div class="fw-bold mt-5">No Hp</div>
                            <div class="text-gray-600"><?= $row['no_hp'] ?></div>

                            <div class="fw-bold mt-5">Alamat</div>
                            <div class="text-gray-600"><?= $row['alamat'] ?></div>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </div>
            </div>
